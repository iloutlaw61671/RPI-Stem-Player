...
driver=webdriver.Chrome('/usr/lib/chromium-browser/chromedriver')    #Using chromium driver
driver.get("https://splitter.ai")                              #splitter.ai url
driver.maximize_window()

upload= (By.XPATH,"//body/div[6]/div[1]/div[2]/div[1]/div[2]/div[4]/div[1]")  #Buttons to click
...
WebDriverWait(driver,20).until(EC.element_to_be_clickable(upload)).click()      #clicking
WebDriverWait(driver,100).until(EC.element_to_be_clickable(no)).click()
